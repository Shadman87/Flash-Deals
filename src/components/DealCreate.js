...
class DealCreate extends React.Component {
  ...
  validate = (
    ...
    if (type === "") {
      this.setState({
        categoryError: "Type needs to be selected",
      });
      validationAlert("Type needs to be selected");
      return false;
    }
    if (date === "") {
      this.setState({
      ...
      <div>
        ...
        <div className="add-form container">
          <form onSubmit={this.addDeal}>
            ...
            <button type="submit" className="btn add-deal-btn-lg">
              Add Deal
            </button>
          </form>
        </div>
